...
class BirthRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'mother_citizen_id' => 'nullable|integer|exists:citizens,citizen_id|different:citizen_id',
            'father_citizen_id' => 'nullable|integer|exists:citizens,citizen_id|different:citizen_id',
