...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('provinces', function (Blueprint $table) {
            ...
            $table->string('province_name_kh', 255);
            $table->string('province_name_en', 255);
        ...
        Schema::create('districts', function (Blueprint $table) {
            ...
            $table->string('district_name_kh', 255);
            $table->string('district_name_en', 255);
        ...
        Schema::create('communes', function (Blueprint $table) {
            ...
            $table->string('commune_name_kh', 255);
            $table->string('commune_name_en', 255);
        ...
        Schema::create('villages', function (Blueprint $table) {
            ...
            $table->string('village_name_kh', 255);
            $table->string('village_name_en', 255);
